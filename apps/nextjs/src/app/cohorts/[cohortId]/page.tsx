...
import { Calendar, Clock, MapPin, Settings, Upload, Users } from "lucide-react";
...
export default function CohortPage({ params }: CohortPageProps) {
  ...
  } = useQuery(trpc.cohort.getById.queryOptions(resolvedParams.cohortId));
            ...
            {userMembership && !userApplication && (
              <Card>
                ...
                <CardContent>
                  <Badge
                    variant="outline"
                    className={memberStatusColors[userMembership.status]}
                  >
