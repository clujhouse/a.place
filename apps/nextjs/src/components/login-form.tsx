  ...
  async function handleVerifyOTP(e: FormEvent) {
    ...
    try {
      ...
      if (data) {
        ...
        if (onSuccess) {
          // If we have an onSuccess callback (dialog mode), call it
          onSuccess();
          router.refresh();
        } else {
          // Otherwise redirect to homepage (page mode)
          router.push("/");
          router.refresh();
        }
      }
        ...
        <form className="p-6 md:p-8" onSubmit={handleSendOTP}>
          <div className="flex flex-col gap-6">
            <div className="flex flex-col items-center text-center">
              <h1 className="text-2xl font-bold">you are cool </h1>
